RSpec.describe HmctsCommonPlatform::CaseSummary, type: :model do
  ...
  it "generates a JSON representation of the data" do
    expect(case_summary.as_json[:case_status]).to eql("INACTIVE")
    expect(case_summary.as_json[:prosecution_case_id]).to eql("33ef3cfe-b2c3-4694-9ccb-0ebfbd0d2564")
    expect(case_summary.as_json[:prosecution_case_reference]).to eql("29GD7216523")
  end

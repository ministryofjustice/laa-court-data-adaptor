RSpec.describe LinkingStatCollator do
  ...
  it "shows stats for the current range" do
    ...
    create(:laa_reference, defendant_id: SecureRandom.uuid, maat_reference: "1234567", user_name: "abcde",
                           created_at: Time.zone.local(2025, 9, 7, 10, 0, 0), linked: true)

    # Linked on the last day of the range
    create(:laa_reference, defendant_id: SecureRandom.uuid, maat_reference: "2345678", user_name: "abcde",
                           created_at: Time.zone.local(2025, 9, 13, 10, 0, 0), linked: true)

    # Linked outside the range
    create(:laa_reference, defendant_id: SecureRandom.uuid, maat_reference: "3456789", user_name: "abcde",
                           created_at: Time.zone.local(2025, 9, 14, 10, 0, 0), linked: true)

    # Created inside the range and unlinked
    create(:laa_reference, defendant_id: SecureRandom.uuid, maat_reference: "4567890", user_name: "abcde",

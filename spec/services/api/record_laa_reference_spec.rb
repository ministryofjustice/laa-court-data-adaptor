...
RSpec.describe Api::RecordLaaReference do
  ...
  let(:api_request_url) { "/record/laareference-sit/progression-command-api/command/api/rest/progression/laaReference/cases/#{prosecution_case_id}/defendants/23d7f10a-067a-476e-bba6-bb855674e23b/offences/147fed98-ba8a-46cb-b2b4-7c41cf4734bf" }

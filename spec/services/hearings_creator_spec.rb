...
RSpec.describe HearingsCreator do
  ...
  let(:defendant_one) do
    {
      "id": "c6a0439f-8d18-4e69-8dd3-3ccfdfaeb402",
  ...
  let(:defendant_two) do
    {
      "id": "70913b3b-c313-4c97-b1b9-e9598df0b652",
      "offences": [{
        "laaApplnReference": {
  ...
  context "when a trial" do
    ...
    context "with one defendant" do
      it "calls the Sqs::MessagePublisher service once" do
        LaaReference.create!(defendant_id: defendant_one[:id], linked: true, maat_reference: "123", user_name: "Bob")
    ...
    context "with two defendants" do
      ...
      it "calls the Sqs::PublishLaaReference service twice" do
        LaaReference.create!(defendant_id: defendant_one[:id], linked: true, maat_reference: "123", user_name: "Bob")
        LaaReference.create!(defendant_id: defendant_two[:id], linked: true, maat_reference: "345", user_name: "Tom")

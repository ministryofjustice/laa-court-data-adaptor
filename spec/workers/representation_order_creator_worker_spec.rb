...
RSpec.describe RepresentationOrderCreatorWorker, type: :worker do
  ...
  it "creates a CommonPlatformApi::RepresentationOrderCreator and calls it" do
    Sidekiq::Testing.inline! do
      expect(CommonPlatformApi::RepresentationOrderCreator).to receive(:call).once.with(

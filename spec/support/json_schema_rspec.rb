RSpec.configure do |config|
  ...
  config.json_schemas[:defendant_court_application_summary] = "#{schema_path}/global/apiDefendantCourtApplicationSummary.json"
  ...
  config.json_schemas[:hearing_event_log] = "#{schema_path}/api/hearing.api.hearingEventLogResponse.json"

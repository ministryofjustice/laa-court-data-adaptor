...
module CommonPlatform
  module Api
    class CourtApplicationRepresentationOrderCreator < ApplicationService
      def initialize(subject_id:, offences:, maat_reference:, defence_organisation:)
    ...
    private
      ...
      attr_reader :subject_id, :offences, :maat_reference, :defence_organisation, :contact
    end
  end
end

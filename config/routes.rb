  ...
  namespace :api do
    namespace :internal do
      ...
      namespace :v2 do
        ...
        resources :link_migrated_cases, only: %i[index show], controller: :migrated_cases
        resources :link_migrated_cases, only: [:create]
        ...
        get "stats/linking", to: "stats#index_linking"
      end
    end
